                            ...
                            <tr id="<?php echo $produto['id']; ?>">
                                ...
                                <td class="text-center botoes coltabela">
                                    ...
                                    <?php if ($_SESSION['nivel_acesso'] == 1) { ?>
                                        <a class="delete_produto" id="<?php echo $produto['id']; ?>"><button type="button" class="btn btn-danger btn-sm mr-2 btnExcluir" name="btnExcluir" value="btnExcluir">Excluir</button></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
